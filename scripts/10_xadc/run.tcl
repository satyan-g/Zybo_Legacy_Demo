# run.tcl — Program FPGA and run XADC demo on Zynq ARM core
# Run: xsct scripts/10_xadc/run.tcl
#
...
set elf_file "$out_dir/xadc_demo.elf"

# Try app-level ps7_init first, then fall back to platform-level
set ps7_init_tcl "$out_dir/vitis_workspace/xadc_demo/_ide/psinit/ps7_init.tcl"

puts "============================================"
puts " Running: 10_xadc on Zybo"
puts "============================================"
...
puts "\n============================================"
puts " XADC demo is running!"
puts " Check your serial console (picocom)"
puts " LEDs show temperature level"
puts "============================================"
