# build_hw.tcl — Vivado TCL script for 13_sd_boot
# Builds PS + AXI GPIO block design, synthesizes, implements, exports XSA
# Usage: vivado -mode batch -source scripts/13_sd_boot/build_hw.tcl

set script_dir [file dirname [info script]]
set proj_root  [file normalize "$script_dir/../.."]
set out_dir    "$proj_root/output/13_sd_boot"
set proj_name  "sd_boot"
...
# Add constraints
add_files -fileset constrs_1 "$proj_root/constrs/13_sd_boot/zybo_sd_boot.xdc"
