...
set elf_file "$out_dir/audio_demo.elf"

# Try multiple paths for ps7_init.tcl
set ps7_init_tcl "$out_dir/vitis_workspace/audio_demo/_ide/psinit/ps7_init.tcl"
...
if {![file exists $ps7_init_tcl]} {
    ...
    puts "Tried: $out_dir/vitis_workspace/audio_demo/_ide/psinit/ps7_init.tcl"
