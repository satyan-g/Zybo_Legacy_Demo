...
set elf_file "$sw_dir/ethernet_demo.elf"

# Try multiple paths for ps7_init.tcl
set ps7_init_tcl "$sw_dir/vitis_workspace/ethernet_demo/_ide/psinit/ps7_init.tcl"
...
if {![file exists $ps7_init_tcl]} {
    ...
    puts "Tried: $sw_dir/vitis_workspace/ethernet_demo/_ide/psinit/ps7_init.tcl"
