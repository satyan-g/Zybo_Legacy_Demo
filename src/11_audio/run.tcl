# run.tcl — Program FPGA and run audio demo on Zynq ARM core
# Run: xsct scripts/11_audio/run.tcl
#
# Open serial console BEFORE running: ./scripts/console.sh
# Plug headphones into the Zybo headphone jack to hear the tone.
...
set elf_file "$sw_dir/audio_demo.elf"

# Try multiple paths for ps7_init.tcl
set ps7_init_tcl "$sw_dir/vitis_workspace/audio_demo/_ide/psinit/ps7_init.tcl"
if {![file exists $ps7_init_tcl]} {
    set ps7_init_tcl "$sw_dir/vitis_workspace/zybo_platform/hw/sdt/ps7_init.tcl"
}

puts "============================================"
puts " Running: 11_audio on Zybo"
puts "============================================"
...
if {![file exists $ps7_init_tcl]} {
    ...
    puts "Tried: $sw_dir/vitis_workspace/audio_demo/_ide/psinit/ps7_init.tcl"
...
puts "\n============================================"
puts " Audio demo is running!"
puts " Check your serial console (picocom)"
puts " Plug headphones into the Zybo HP jack"
puts " You should hear a ~750 Hz sine tone."
puts "============================================"
