...
set elf_file "$sw_dir/axi_gpio_demo.elf"

# Try multiple paths for ps7_init.tcl
set ps7_init_tcl "$sw_dir/vitis_workspace/axi_gpio_demo/_ide/psinit/ps7_init.tcl"
...
if {![file exists $ps7_init_tcl]} {
    ...
    puts "Tried: $sw_dir/vitis_workspace/axi_gpio_demo/_ide/psinit/ps7_init.tcl"
