# run.tcl — Program FPGA and run AXI DMA loopback demo on Zynq ARM core
# Run: xsct scripts/09_dma/run.tcl
#
...
if {![file exists $ps7_init_tcl]} {
    ...
    puts "Tried: $sw_dir/vitis_workspace/dma_demo/_ide/psinit/ps7_init.tcl"
...
puts "\n============================================"
puts " AXI DMA loopback demo is running!"
puts " Check your serial console (picocom)"
puts " for transfer results."
puts "============================================"
